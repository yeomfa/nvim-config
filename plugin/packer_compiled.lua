...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/yeom/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  ["vim-react-snippets"] = {
    loaded = true,
    path = "/home/yeom/.local/share/nvim/site/pack/packer/start/vim-react-snippets",
